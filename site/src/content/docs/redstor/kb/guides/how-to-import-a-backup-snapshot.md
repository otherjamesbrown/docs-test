...
5.  Click **Start Upload** to start the import process. The time this takes depends on the size of the snapshot.  
    _**Note:** If you see an error "Backup Snapshot task has been queued", please consult [Article 582](https://helpdesk.redstor.com/support/solutions/articles/4000219768)._  
