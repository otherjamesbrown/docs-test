...
> Source: [support.titanhq.com](https://support.titanhq.com/en/62894-insights.html)
> Product: PhishTitan
...
![PT-Threat-Surfact-Report-Whole.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/f7362b8fca0e.jpg)
...
For a more high-level view of phishing activity, see the [Summary Report](/docs-test/titanhq/products/phishtitan/docs/email-security/summary-report/ "Summary Report"), which provides a list of the top targeted users and incident sources.
...
-   **Date Range**
    ...
    ![PT-Threat-Surfact-Select-Date-Range.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/c96542d3b2aa.jpg)

-   **Customer Table**

    All of your customers are shown in the **Customer** table with those in receipt of the most phishing emails at the top.

    ![PT-Threat-Surfact-Select-Customer.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/3728bffbd340.jpg)
    ...
    ![PT-Threat-Surfact-Select-Specific-Customer.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/95383fdd50ec.jpg)
...
-   **Targeted Users Table**
    ...
    ![PT-Threat-Surfact-Select-Receiver.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/0e1489f48ad6.jpg)
    ...
    ![PT-Threat-Surfact-Select-Receiver1.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/09ad49be0bc2.jpg)
...
-   **Who Attacked Who?**
    ...
    ![PT-Threat-Surfact-Who-Attacked-Who.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/b6272220071d.jpg)
    ...
    -   _Incident Sources_: The email address of the source of the phishing email. If you select the expand icon beside it, the email addresses of those who received the phishing emails are displayed.
        ...
        ![PT-Reporting-Expand-Icon-Example.jpg](/docs-test/imported-assets/phishtitan-docs/62894-insights/5237e694375e.jpg)
