...
> Source: [support.titanhq.com](https://support.titanhq.com/en/66842-add-a-journaling-rule.html)
> Product: PhishTitan
...
3.  Select the ![copy-icon.jpg](/docs-test/imported-assets/phishtitan-docs/66842-add-a-journaling-rule/b25416526d89.jpg) icon to copy your unique journaling email address.
...
6.  Select the ![ST-701-office365-add-button.jpg](/docs-test/imported-assets/phishtitan-docs/66842-add-a-journaling-rule/3d6259cd5013.jpg) **New rule** tab.
...
9.  Under _Type of message to journal,_ select **All messages**. The completed form should look as follows:
    ...
    ![PT-completed-journal-rule-form.jpg](/docs-test/imported-assets/phishtitan-docs/66842-add-a-journaling-rule/e6b8973ddaf7.jpg)
