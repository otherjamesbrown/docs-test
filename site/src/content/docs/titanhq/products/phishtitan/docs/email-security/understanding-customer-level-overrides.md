...
> Source: [support.titanhq.com](https://support.titanhq.com/en/78981-understanding-customer-level-overrides.html)
> Product: PhishTitan
...
![msp\_antispoof.png](/docs-test/imported-assets/phishtitan-docs/78981-understanding-customer-level-overrides/ad03d170a72a.png)

A customer of this MSP also adds an exemption for the same email address, but for the security checks _Spam_ and _Fraud_.

![customer\_spam\_fraud.png](/docs-test/imported-assets/phishtitan-docs/78981-understanding-customer-level-overrides/813403166004.png)
...
![customer\_antispoof.png](/docs-test/imported-assets/phishtitan-docs/78981-understanding-customer-level-overrides/4f0ff2537c55.png)
