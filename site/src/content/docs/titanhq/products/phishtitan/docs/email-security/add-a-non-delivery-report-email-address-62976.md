...
> Source: [support.titanhq.com](https://support.titanhq.com/en/62976-add-a-non-delivery-report-email-address.html)
> Product: PhishTitan
> Imported content type: docs_page
> Product stream: email-security

##### Add a Non-Delivery Report Email Address
...
3.  Select the copy ![copy-icon.jpg](/docs-test/imported-assets/phishtitan-docs/62976-add-a-non-delivery-report-email-address/b25416526d89.jpg) icon to copy your unique NDR email address.
...
Next, you'll need to [create a journaling rule](/docs-test/titanhq/products/phishtitan/docs/email-security/add-a-journaling-rule-62977/ "Add a Journaling Rule") to allow email flow through the Email Security service.
