...
> Source: [support.titanhq.com](https://support.titanhq.com/en/78399-managing-email-history.html)
> Product: PhishTitan
...
![ES-Email-History-Filter.jpg](/docs-test/imported-assets/phishtitan-docs/78399-managing-email-history/53dccfecee81.jpg)

Click on an email to view its details. A slideout panel appears with the Message section displayed by default. You can take action on some emails by selecting **Actions**. See [Taking Action on an Email](/docs-test/titanhq/products/phishtitan/docs/email-security/taking-action-on-an-email/ "Taking Action on an Email") for details.

![ES-Email-History-Slideout.jpg](/docs-test/imported-assets/phishtitan-docs/78399-managing-email-history/de5b8e578946.jpg)
