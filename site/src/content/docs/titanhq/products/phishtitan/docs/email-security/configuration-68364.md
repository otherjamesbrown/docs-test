...
> Source: [support.titanhq.com](https://support.titanhq.com/en/68364-configuration.html)
> Product: PhishTitan
...
-   **[Mail Flow](/docs-test/titanhq/products/phishtitan/docs/email-security/customer-mail-flow/ "Customer Mail Flow")**, where you can manage how mail is processed before it's delivered to a user. This includes:
...
-   [Exemptions](/docs-test/titanhq/products/phishtitan/docs/email-security/exemptions-78989/)
-   [Link Lock](/docs-test/titanhq/products/phishtitan/docs/email-security/link-lock-66570/)
