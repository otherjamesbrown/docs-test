...
> Source: [support.titanhq.com](https://support.titanhq.com/en/78992-adding-ip-exemptions.html)
> Product: PhishTitan
> Imported content type: docs_page
> Product stream: email-security

###### Adding IP Exemptions
...
If you want to add individual email addresses or domains as Exemptions, see [Adding Email Exemptions](/docs-test/titanhq/products/phishtitan/docs/email-security/adding-sender-email-address-exemptions/ "Adding Sender Email Address Exemptions") or [Adding Domain Exemptions](/docs-test/titanhq/products/phishtitan/docs/email-security/adding-domain-exemptions/ "Adding Domain Exemptions").
...
1.  Go to **Email Security** > **Configuration** > **Exemptions** where you'll see the All tab is open by default. You can add exemptions from here or select the **IPs** tab. Select **Add Exemption**.
    ...
    ![ES-Exemptions-Customers-All.jpg](/docs-test/imported-assets/phishtitan-docs/78992-adding-ip-exemptions/3367c5212249.jpg)

    The Add Exemption window opens.

    ![ES-Exemptions-Customers-Add-Exemp-Window.jpg](/docs-test/imported-assets/phishtitan-docs/78992-adding-ip-exemptions/a0386db64439.jpg)
