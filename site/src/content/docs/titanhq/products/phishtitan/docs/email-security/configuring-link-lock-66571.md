...
> Source: [support.titanhq.com](https://support.titanhq.com/en/66571-configuring-link-lock.html)
> Product: PhishTitan
...
2.  Select the **Policy Configuration** tab to configure your settings:
    ...
    -   _Display default logo on the block page_: Displays the image currently being used on the Link Lock block page. Default:
        ...
        ![PT-link-lock-default-logo.jpg](/docs-test/imported-assets/phishtitan-docs/66571-configuring-link-lock/e957cad15885.jpg)
...
<table><tbody><tr><td><div><img src="/docs-test/imported-assets/phishtitan-docs/66571-configuring-link-lock/a8a00af5d05c.jpg" alt="PT-link-lock-block-page.jpg"></div></td><td><div><img src="/docs-test/imported-assets/phishtitan-docs/66571-configuring-link-lock/a5af0c8eb577.jpg" alt="PT-link-lock-block-page-detail.jpg"></div></td></tr></tbody></table>
