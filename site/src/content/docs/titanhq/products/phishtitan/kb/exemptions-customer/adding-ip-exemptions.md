...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000228159-adding-ip-exemptions)
> Product: PhishTitan
...
1.  Go to **Email Security** > **Configuration** > **Exemptions** where you'll see the All tab is open by default. You can add exemptions from here or select the **IPs** tab. Select **Add Exemption**.
    ...
    ![ES-Exemptions-Customers-All.jpg](/docs-test/imported-assets/phishtitan-kb/4000228159/3367c5212249.jpg)

    The Add Exemption window opens.

    ![ES-Exemptions-Customers-Add-Exemp-Window.jpg](/docs-test/imported-assets/phishtitan-kb/4000228159/a0386db64439.jpg)
