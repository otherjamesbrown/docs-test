...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000226791-managing-email-history)
> Product: PhishTitan
> Imported content type: kb_article
> Source folder: Email History (MSP)
> Modified: Wed, 15 Apr, 2026 at 10:50 AM

Go to **Email Security** > **Email History** to select an email in the list to view the email summary. Use the filter options to locate specific emails, based on **Date**, **Verdict**, **Status** and **Customer**. For example, when you select **Status**, a dropdown checklist appears from which you can select one or more options to filter email history results.

![ES-Email-History-Filter.jpg](/docs-test/imported-assets/phishtitan-kb/4000226791/53dccfecee81.jpg)

Click on an email to view its details. A slideout panel appears with the Message section displayed by default. You can take action on some emails by selecting **Actions**. See [Taking Action on an Email](/docs-test/titanhq/products/phishtitan/kb/email-history-msp/taking-action-on-an-email/ "Taking Action on an Email") for details.

![ES-Email-History-Slideout.jpg](/docs-test/imported-assets/phishtitan-kb/4000226791/de5b8e578946.jpg)
