...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000194418-add-a-non-delivery-report-email-address)
> Product: PhishTitan
...
3.  Select the copy ![copy-icon.jpg](/docs-test/imported-assets/phishtitan-kb/4000194418/b25416526d89.jpg) icon to copy your unique NDR email address.
...
Next, you'll need to [create a journaling rule](/docs-test/titanhq/products/phishtitan/kb/getting-started-msp-admin/add-a-journaling-rule/ "Add a Journaling Rule") to allow email flow through the Email Security service.
