...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000202547-incidents)
> Product: PhishTitan
> Imported content type: kb_article
> Source folder: Incidents
> Modified: Tue, 28 Oct, 2025 at 3:50 PM
...
:::note
If you have auto remediation set up, then Email Security will automatically send malicious mails to a user's junk folder. See [Remediation](/docs-test/titanhq/products/phishtitan/kb/remediation/msp-remediation/) for more details.
:::
...
![PT-Incident-Tabs.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/d02d84121153.jpg)
...
1.  Select the Incident(s) to be remediated to reveal an Actions dropdown menu in the upper-right corner.
    ...
    ![ES-MultiSelect-Selection.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/7e0986965260.jpg)

2.  Select **Actions** > **Remediate** to remove the emails from affected inboxes.

    ![ES-MultiSelect-Dropdown-onlyRemediate.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/4d95468042fb.jpg)
...
3.  A pop-up window will notify you of the emails to be remediated and indicate if some incidents are not available for remediation. Select **Start Remediation** to begin the process.
    ...
    ![ES-MultiSelect-Confirmation-Popup.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/dcd6491b7b6a.jpg)

    You’ll see an Action Status notification, as in the example below, informing you of the remediation progress.

    ![ES-MultiSelect-Action-Progress-Completion.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/bd6f148545f4.jpg)
...
See [Taking Action on an Incident](/docs-test/titanhq/products/phishtitan/kb/incidents/taking-action-on-an-incident/ "Taking Action on an Incident") for further information on managing Incidents.

To manage how Incidents are displayed, you can do the following:

-   Use the search ![search-incidents.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/6974c408d7c8.jpg) box to search the list of incidents.

-   Select the column ![ES-Column-Reorder-icon.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/9ff217c6917f.jpg) icon to manage table columns. By default, all columns are visible and arranged in a specific order. You can change the display by doing the following:

    ![ES-Column-Reorder.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/0219ecd4cc35.jpg)
    ...
    -   Use the reordering ![ES-Reordering-icon.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/75ef450eda3f.jpg) icon to move columns up and down the list. This changes the left-to-right display. An item at the top of the list, for example, means that it will be the first column on the left. Select **Restore default order** to restore the columns to their default positions.

    -   Resize columns by hovering your cursor over the column boundary you want to adjust until it becomes a resize ![ES-Resize-Cursor.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/3b077003c7a7.jpg) cursor. Drag the boundary until the column is the width you want.
    ...
    -   _Flag Reason_: The reason this email was flagged for further investigation. See [Incident Flag Reasons](/docs-test/titanhq/products/phishtitan/kb/incidents/incidents/ "Incident Flag Reasons").

    -   _Status_: The current status of this incident. See [Incident Status Descriptions](/docs-test/titanhq/products/phishtitan/kb/incidents/incidents/ "Incident Status Descriptions").
...
-   From the Actions column, you can do the following:
    ...
    -   To add a sender to the Allow List, select the allow sender ![PT-Allow-List-Icon.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/3e5939c61b17.jpg) icon for the incident. See Allow List for further details.

    -   To add a domain to the Allow List, select the allow domain ![PT-Allow-Domain-Icon.jpg](/docs-test/imported-assets/phishtitan-kb/4000202547/761f9fc9da7a.jpg) icon for the incident. See Allow List for further details.

To [view additional details of an incident](/docs-test/titanhq/products/phishtitan/kb/incidents/viewing-an-incident/ "Viewing an Incident"), locate the incident in the table and select it. See [Incident Summary](/docs-test/titanhq/products/phishtitan/kb/incidents/viewing-an-incident/ "Incident Summary") for further details.
...
<table width="100%"><colgroup><col width="20%"><col width="50%"><col width="25%"></colgroup><thead><tr><th><p>Status</p></th><th><p>Description</p></th><th><p>Available Actions</p></th></tr></thead><tbody><tr><td><div><img src="/docs-test/imported-assets/phishtitan-kb/4000202547/e4220470dee3.jpg" alt="action-needed.jpg" data-xinfo-image="66286"></div></td><td><p>An email has been flagged by a user as phishing or clean using the TitanHQ for Outlook add-in.</p><p>This incident needs Admin attention and review.</p><div dir="ltr" data-import-admonition="note" data-import-admonition-title="Note"><h3>Note</h3><p>If the email has been sent to only one recipient and has been reported as phishing, then it is automatically remediated to the junk folder.</p></div></td><td><p>Remediate</p><p>Mark as Safe</p><p>Allow Sender</p><p>Allow Domain</p></td></tr><tr><td><div><img src="/docs-test/imported-assets/phishtitan-kb/4000202547/f87752bd664f.jpg" alt="sent-to-junk.jpg" data-xinfo-image="66285"></div></td><td><p>Emails can be sent to junk in the following ways:</p><div><ul><li><p>Administrator has reviewed this email and determined it was malicious and selected to move it to a user's Junk folder.</p></li><li><p>An email has been flagged by a user as phishing using the TitanHQ for Outlook add-in.</p></li></ul></div><p>This email has been moved to the Junk folder for all recipients.</p></td><td><p>Mark as Safe</p><p>Allow Sender</p><p>Allow Domain</p></td></tr><tr><td><div><img src="/docs-test/imported-assets/phishtitan-kb/4000202547/2bc09fe51906.jpg" alt="banner-applied.jpg" data-xinfo-image="66284"></div></td><td><p>Email Security has flagged this email as suspicious and applied a warning banner before delivering it to a user's Inbox.</p></td><td><p>Remediate</p><p>Mark as Safe</p><p>Allow Sender</p><p>Allow Domain</p></td></tr><tr><td><div><img src="/docs-test/imported-assets/phishtitan-kb/4000202547/73b3c504d1b8.jpg" alt="PT-Actions-Marked-As-Safe.jpg" data-xinfo-image="67485"></div></td><td><p>Administrator has reviewed this email and determined it is safe. Once marked as safe, the email is then delivered to all recipients with a banner marking it as safe.</p></td><td><p>Remediate</p><p>Allow Sender</p><p>Allow Domain</p></td></tr><tr><td><div><img src="/docs-test/imported-assets/phishtitan-kb/4000202547/4358129122bc.jpg" alt="PT-Auto-Remediated-Label.jpg" data-xinfo-image="68355"></div></td><td><p>Auto remediation has been enabled meaning that this email has automatically been moved to the Junk folder for all recipients.</p></td><td><p>Allow Sender</p><p>Mark as Safe</p></td></tr></tbody></table>
