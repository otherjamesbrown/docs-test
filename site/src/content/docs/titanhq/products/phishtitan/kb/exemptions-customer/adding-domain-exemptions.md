...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000228158-adding-domain-exemptions)
> Product: PhishTitan
...
You can also add Exemptions for sending email addresses and IPs. See [Adding Email Exemptions](/docs-test/titanhq/products/phishtitan/kb/exemptions-msp/adding-sender-email-address-exemptions/) and [Adding IP Exemptions](/docs-test/titanhq/products/phishtitan/kb/exemptions-msp/adding-ip-exemptions/).
...
1.  Go to **Email Security** > **Configuration** > **Exemptions** where you'll see the All tab is open by default. You can add exemptions from here or select the **Domains** tab. Select **Add Exemption**.
    ...
    ![ES-Exemptions-Customers-All.jpg](/docs-test/imported-assets/phishtitan-kb/4000228158/3367c5212249.jpg)

    The Add Exemption window opens.

    ![ES-Exemptions-Customers-Add-Exemp-Window.jpg](/docs-test/imported-assets/phishtitan-kb/4000228158/a0386db64439.jpg)
