...
> Source: [helpdesk.phishtitan.com](https://helpdesk.phishtitan.com/support/solutions/articles/4000228150-adding-sender-email-address-exemptions)
> Product: PhishTitan
...
You can also add Exemptions for entire domains and IPs. See [Adding Domain Exemptions](/docs-test/titanhq/products/phishtitan/kb/exemptions-msp/adding-domain-exemptions/ "Adding Domain Exemptions") and [Adding IP Exemptions](/docs-test/titanhq/products/phishtitan/kb/exemptions-msp/adding-ip-exemptions/ "Adding IP Exemptions") for further details.
...
1.  Go to **Email Security** > **Configuration** > **Exemptions** where you'll see the All tab is open by default. You can add exemptions from here or select the **Emails** tab. Select **Add Exemption**.
    ...
    ![ES-Exemptions-MSP-AddExempt.jpg](/docs-test/imported-assets/phishtitan-kb/4000228150/612480697d3e.jpg)

    The Add Exemption window opens.

    ![ES-Exemptions-MSP-AddExempt-Window.jpg](/docs-test/imported-assets/phishtitan-kb/4000228150/aca62708fc18.jpg)
