...
> Source: [support.titanhq.com](https://support.titanhq.com/en/65244-creating-a-single-pattern-filter.html)
> Product: SpamTitan
...
2.  Complete the fields as follows:
    ...
    -   _Apply to Headers_: By default, a pattern filter triggers on any header. Therefore, if this field is selected and left empty, the pattern filter is triggered on all headers.
        ...
        ![ST-SK-pattern-filter-header-box.jpg](/docs-test/imported-assets/spamtitan-skellig/65244-creating-a-single-pattern-filter/1c4c54511c8d.jpg)
