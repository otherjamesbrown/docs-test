...
> Source: [support.titanhq.com](https://support.titanhq.com/en/61219-creating-a-scheduled-report.html)
> Product: SpamTitan
...
1.  Select **Reporting** > **Scheduled** and select **Add**.
    ...
    ![ST-SK-add-scheduled-report.jpg](/docs-test/imported-assets/spamtitan-skellig/61219-creating-a-scheduled-report/8762b1ba57b7.jpg)
...
2.  Complete the fields in the Add Scheduled Report window:
    ...
    -   _Frequency_: Choose one of the following:
        ...
        -   ![daily-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/61219-creating-a-scheduled-report/c24bcf5bb30f.jpg) **Daily**: Generate a report for the previous day’s activity.

        -   ![weekly-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/61219-creating-a-scheduled-report/35b2a9a74953.jpg) **Weekly**: Runs each Monday and produces a report for the previous Monday-Sunday.

        -   ![monthly-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/61219-creating-a-scheduled-report/9860208e83c0.jpg) **Monthly**: Runs on the 1st of the month and produces a report for the previous calendar month.
