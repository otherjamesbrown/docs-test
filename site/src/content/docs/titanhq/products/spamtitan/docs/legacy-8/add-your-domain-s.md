...
> Source: [docs.titanhq.com](https://docs.titanhq.com/en/475-add-your-domain-s-.html)
> Product: SpamTitan
...
1.  Go to **Settings** > **Relay Settings** and click **Add**.  The Add Domain window opens:
    ...
    ![Add Domain window settings](/docs-test/imported-assets/spamtitan-legacy/475-add-your-domain-s-/392385a1c5ea.jpg)

2.  Using the Domain Settings table below as a reference, complete the fields in the Add Domain window.

3.  Click **Save**.

Once a domain is added, click the test button ![ST-701-test-button.jpg](/docs-test/imported-assets/spamtitan-legacy/475-add-your-domain-s-/1d6f3f2c36e2.jpg) in the Options column to validate it.
