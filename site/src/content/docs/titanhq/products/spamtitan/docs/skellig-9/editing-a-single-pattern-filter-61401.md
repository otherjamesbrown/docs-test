...
2.  Edit your pattern details using the information below as reference:
    ...
    -   _Pattern Expression_: Select how this pattern filter is evaluated. Select one of the following:
        ...
        See [https://www.regular-expressions.info](https://www.regular-expressions.info/) ![small\_external\_link.png](/docs-test/imported-assets/spamtitan-skellig/61401-editing-a-single-pattern-filter/5e6d767515b2.png) for information on using regular expression.
