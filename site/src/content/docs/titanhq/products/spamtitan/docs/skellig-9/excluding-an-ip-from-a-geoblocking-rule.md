...
> Source: [support.titanhq.com](https://support.titanhq.com/en/65291-excluding-an-ip-from-a-geoblocking-rule.html)
> Product: SpamTitan
...
2.  Select **Add** > **Sender IP** and the Sender IP window displays:
    ...
    ![ST-SK-geoblocking-add-IP-exemption.jpg](/docs-test/imported-assets/spamtitan-skellig/65291-excluding-an-ip-from-a-geoblocking-rule/ab260c742c83.jpg)
...
-   Select the edit ![edit-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/65291-excluding-an-ip-from-a-geoblocking-rule/90a487f7499b.jpg) icon in the Actions column to edit an exemption.

-   Delete an exemption by selecting the checkbox ![selected-check-box.jpg](/docs-test/imported-assets/spamtitan-skellig/65291-excluding-an-ip-from-a-geoblocking-rule/290997c07565.jpg) beside the exemption name and selecting **Delete**. Multiple exemptions can be deleted together by selecting multiple exemptions and selecting **Delete**.
