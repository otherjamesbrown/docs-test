...
> Source: [support.titanhq.com](https://support.titanhq.com/en/61395-pattern-filtering.html)
> Product: SpamTitan
...
-   Use the search ![search-box.jpg](/docs-test/imported-assets/spamtitan-skellig/61395-pattern-filtering/84196d80bff8.jpg) box to search the list of pattern filters.

-   Select the column ![column-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/61395-pattern-filtering/264f4fd45b19.jpg) icon to display the table column names. Slide each on and off to view or hide a column.

-   To delete a pattern filter, select the box ![selected-check-box.jpg](/docs-test/imported-assets/spamtitan-skellig/61395-pattern-filtering/290997c07565.jpg) beside the pattern filter(s) and select **Delete**.
