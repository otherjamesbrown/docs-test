...
Go to the profile ![profile-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/55584-two-factor-authentication/5225ccde9cb8.jpg) menu and select **Security** to manage 2FA settings. Follow the steps below to set up two-factor authentication.

1.  Before continuing, you must download and install an authenticator phone app. For example, Google Authenticator or FreeOTP.

2.  Click on your profile ![profile-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/55584-two-factor-authentication/5225ccde9cb8.jpg) menu and select **Security**. The Security page opens in a new tab.

3.  Scan the QR Code using the authenticator app installed in step 1.

    ![WT-2FA-QR-code.jpg](/docs-test/imported-assets/spamtitan-skellig/55584-two-factor-authentication/adf54615c043.jpg)
...
![WT-2FA-recovery-codes.jpg](/docs-test/imported-assets/spamtitan-skellig/55584-two-factor-authentication/e60b76efcb95.jpg)
