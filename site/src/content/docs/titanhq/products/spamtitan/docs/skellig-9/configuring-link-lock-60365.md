...
> Source: [support.titanhq.com](https://support.titanhq.com/en/60365-configuring-link-lock.html)
> Product: SpamTitan
...
3.  Select the **Policy Configuration** tab and configure your settings:
    ...
    -   _Show logo on the block page_: Displays the image currently being used on the Link Lock block page. Default:
        ...
        ![ST-default-link-lock-block-page-image.jpg](/docs-test/imported-assets/spamtitan-skellig/60365-configuring-link-lock/ac980f6eb349.jpg)
...
<table><tbody><tr><td><div><img src="/docs-test/imported-assets/spamtitan-skellig/60365-configuring-link-lock/efa1c8f5cf71.jpg" alt="ST-link-lock-block-page.jpg"></div></td><td><div><img src="/docs-test/imported-assets/spamtitan-skellig/60365-configuring-link-lock/33d087ca650f.jpg" alt="ST-link-lock-block-page-all-settings-on.jpg"></div></td></tr></tbody></table>
