...
> Source: [docs.titanhq.com](https://docs.titanhq.com/en/30212-enable-link-lock-for-a-user.html)
> Product: SpamTitan
...
2.  In the **Users** table, click the edit ![ST-701-edit-button.jpg](/docs-test/imported-assets/spamtitan-legacy/30212-enable-link-lock-for-a-user/7455a85c9b68.jpg) icon in the Options column of the user for which you want to enable Link Lock and the Link Lock Configuration (User) window displays:

    ![ST-edit-user-link-lock-config.jpg](/docs-test/imported-assets/spamtitan-legacy/30212-enable-link-lock-for-a-user/b1e4661838c5.jpg)
