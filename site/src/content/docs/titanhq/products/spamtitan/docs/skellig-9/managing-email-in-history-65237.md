...
> Source: [support.titanhq.com](https://support.titanhq.com/en/65237-managing-email-in-history.html)
> Product: SpamTitan
...
![ST-History-Slideout-Main.jpg](/docs-test/imported-assets/spamtitan-skellig/65237-managing-email-in-history/88d8dcae5bcf.jpg)

You can move between emails in the list, and as you select each one, the details are repopulated with the new data. Select the fullscreen ![PT-pop-out-icon.jpg](/docs-test/imported-assets/spamtitan-skellig/65237-managing-email-in-history/d7722aceddac.jpg) icon beside the SpamTitan ID at the top if you want a fullscreen view.
...
![ST-History-Slideout-Main-Details-View.jpg](/docs-test/imported-assets/spamtitan-skellig/65237-managing-email-in-history/43d2874850c8.jpg)
...
![ST-History-Slideout-Main-Message-View.jpg](/docs-test/imported-assets/spamtitan-skellig/65237-managing-email-in-history/3a821cf2a9b4.jpg)

Source View

Select **View Source** to view the email source.

![ST-History-Slideout-Main-Source-View.jpg](/docs-test/imported-assets/spamtitan-skellig/65237-managing-email-in-history/a630a7db2365.jpg)
