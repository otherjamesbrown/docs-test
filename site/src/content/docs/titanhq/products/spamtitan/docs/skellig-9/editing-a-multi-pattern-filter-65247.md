...
> Source: [support.titanhq.com](https://support.titanhq.com/en/65247-editing-a-multi-pattern-filter.html)
> Product: SpamTitan
...
1.  Go to **Filtering** > **Pattern Filtering** and select a multi pattern to edit.
    ...
    ![ST-SK-pattern-filter-table.jpg](/docs-test/imported-assets/spamtitan-skellig/65247-editing-a-multi-pattern-filter/5e20510f6fe6.jpg)
